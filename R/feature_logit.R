...
feature_logit <- function(model, output_folder, cluster_var_vector=NA, output_path, add_dt=NULL) {
  ...
  coeff <- coeff[, .(var_name, estimate, std, odds, odds_CI_0.9_min, odds_CI_0.9_max, 
    odds_CI_0.95_min, odds_CI_0.95_max, 
    p, sign)]
  setnames(coeff, c("var_name", "estimate", "std_clust", "odds", "odds_CI_0.9_min_clust", "odds_CI_0.9_max_clust", 
